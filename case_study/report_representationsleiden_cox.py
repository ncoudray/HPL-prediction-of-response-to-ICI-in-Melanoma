...
l1_ratios   = [0, 0.01, 0.02, 0.03, 0.05, 0.1, 0.15]
alphas      = 10. ** np.linspace(-3, 2, 50)

# resolutions = [0.4, 0.7, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0]
# No  more than 9
# resolutions = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.2, 1.4, 1.5, 1.6, 1.8, 1.9, 2.0, 2.1, 2.25, 2.5, 3.0, 4.0, 5.0, 6.0, 7.0]
# resolutions = [1.0, 1.2, 1.4, 1.5, 1.6, 1.8, 1.9, 2.0, 2.1]
#resolutions = [0.4, 0.7, 0.8, 0.9, 1.4, 2.0, 2.1, 2.25, 2.5]
# resolutions = [0.05, 0.06, 0.07, 0.08, 0.09,  0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 1.0, 1.02, 1.04, 1.1, 1.2, 1.3, 1.4, 1.5, 1.75, 2.0, 2.5, 3.0, 4.0, 5.0, 7.0, 9.0]
resolutions = [0.1, 0.3, 0.5, 0.85, 2.5, 4.0, 5.0]
