...
def plot_KM_high_low(high_risk_df, low_risk_df, ax_title, ax, event_ind_field, event_data_field, max_months=None):
    ...
    kmf_l.plot_survival_function(show_censors=True, ci_show=True, ax=ax, color='#C7B60A')
    kmf_h.plot_survival_function(show_censors=True, ci_show=True, ax=ax, color='#6F2DA8')
