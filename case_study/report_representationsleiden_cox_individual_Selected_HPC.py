...
if args.remove_clusters_type == None:
	...
	#remove_clusters = [0, 1, 4,5, 7,8, 11,12 ,15,16, 18, 21,22,28,32,34, 36,38,39,42,43,45,47,50,51]
	remove_clusters = [0, 1, 4,5, 7,8, 11,12 ,15,16, 18, 21,22,28,32,34, 36,38,39,42,43,45,47,50,51, 9, 10, 17,19,20,27,35,41,44]
	# left: 2,3,6,13,14,23,24,25,26,29,30,31,33,37,40,46,48,49
elif args.remove_clusters_type == 'anti-PD1':
	#remove_clusters = [1,2,3, 5,7,9,10,13,15,16,17,19,21,22,25,27,28,30,32,34,35,37,39,40,41,42,44,45,46,50,51]
	# 3/4 consistent:
	# remove_clusters = [1,2,3, 5,7,9,10,13,15,16,17,19,21,22,25,27,28,30,32,34,35,37,39,40,41,42,44,45,46,50,51, 4,14, 23,29,33,43,47]
	# left: 0,6, 8, 11, 12, 18,20, 24,26, 31,36, 38, 48, 49
	# all consistent:
